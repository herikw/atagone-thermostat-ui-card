...
const CLIMATE_LABELS = ["eco_temperature", "disable_summer", "disable_eco", "disable_heat", "disable_menu", "set_current_as_main", "disable_buttons"] as string[];
...
@customElement("atagone-thermostat-ui-card-editor")
